...
共设计 **25-30 道题**，分为 **5 个灵魂维度**：

| 维度 | 题数 | 题目类型 | 测量目标 |
|------|------|---------|---------|
| 🌌 **认知之门** | 6 题 | 场景选择 + 偏好判断 | 开放性、想象力 |
| 🔥 **意志熔炉** | 6 题 | 行为倾向 + 自评 | 尽责性、自律 |
| 🌊 **情感海洋** | 6 题 | 情绪反应 + 社交场景 | 外向性、情绪风格 |
| 💚 **关系之网** | 5 题 | 人际场景 + 价值判断 | 宜人性、同理心 |
| 🌙 **内心深渊** | 5 题 | 投射场景 + 自我认知 | 情绪调节、核心动机 |
...
> 📝 **文档版本**：v1.1  
> **创建日期**：2026-06-20  
> **最后更新**：2026-06-20 — 新增管理员 Webhook 数据回传系统  
> **状态**：待确认，确认后进入实施阶段
